...
<?php pb_backupbuddy::$ui->start_metabox( 'Welcome', true, 'width: 70%;' ); ?>
	...
	echo '?page=pb_backupbuddy_settings">Setting</a> before use:</b>';
	?>
...
<?php pb_backupbuddy::$ui->start_metabox( __('Logging & Debugging', 'it-l10n-backupbuddy' ), true, 'width: 70%;' );; ?>
	<?php
	...
	?>
	<p>
		<a href="<?php echo pb_backupbuddy::page_url(); ?>&reset_log=true" class="button secondary-button"><?php _e('Clear Log', 'it-l10n-backupbuddy' );?></a>
		&nbsp;
		<a href="<?php echo pb_backupbuddy::page_url(); ?>&cleanup_now=true" class="button secondary-button"><?php _e('Cleanup Temp Data', 'it-l10n-backupbuddy' );?></a>
		&nbsp;
		...
		&nbsp;
		<a id="pluginbuddy_debugtoggle" class="button secondary-button">Debugging Info</a>
		&nbsp;
